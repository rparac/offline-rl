...
from offline_rl.vlm.contrib.sb3.make_vec_env import make_vec_env
from offline_rl.vlm.contrib.sb3.signal_handler import end_signal_handler
from offline_rl.vlm.contrib.sb3.subproc_vec_env import SubprocVecEnv
from offline_rl.vlm.envs.base import get_clip_rewarded_env_name, get_make_env, get_visual_minecraft_make_env, is_3d_env
from offline_rl.vlm.reward_model import dist_worker_compute_reward, load_reward_model_from_config
from offline_rl.vlm.trainer.config import CLIPRewardConfig, Config
...
def primary_worker(
    ...
    make_env_fn = get_visual_minecraft_make_env(config.rl.episode_length)
