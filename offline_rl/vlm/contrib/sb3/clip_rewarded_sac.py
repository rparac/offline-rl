...
from offline_rl.vlm.contrib.sb3.clip_buffer import CLIPReplayBuffer

from offline_rl.vlm.trainer.config import Config, CLIPRewardConfig
from offline_rl.vlm.visual_minecraft_success_detector import compute_visual_minecraft_rewards, load_visual_minecraft_similarity_model
...
class CLIPRewardedSAC(SAC):
    ...
    def _load_modules(self):
        ...
        self.reward_model = similarity_model
